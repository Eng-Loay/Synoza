    ...
    >
      <div className="p-5 flex-1 flex flex-col gap-4">
        ...
        {lockedByPlan ? (
          <Link
            to="/student/upgrade"
            className="w-full py-3 rounded-xl text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 bg-slate-800 text-white hover:bg-slate-900 transition-colors"
          >
            <Lock size={14} />
